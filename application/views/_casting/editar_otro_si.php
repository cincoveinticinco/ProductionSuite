...
<div id="inner_content">
    <div class="columns twelve">
      <?php echo form_open_multipart($idioma.'casting/update_solicitud_otro_si','id="crear_solicitud", class="", onSubmit=""');?>
          ...
          <div class="row">
              ...
              <div class="row datos_actor">
                  ...
                  <div class="column two">
                    ...
                    <?php if($solicitud[0]->fecha_final!=$solicitud[0]->fecha_final_otro_si and $solicitud[0]->fecha_final_otro_si!=null and $solicitud[0]->fecha_final_otro_si!='0000-00-00' ){ ?>
                        <input type="text" name="fecha_final_otro_si" id="fecha_final_casting" class="required old_field" value="<?=date("d-M-Y", strtotime($solicitud[0]->fecha_final_otro_si))?>" style="background: #FAFACA;">
                    <?php }else{ ?>
               ...
               <div class="row datos_actor">
                    ...
                    <div class="column two">
                    <label for=""><?php echo lang('global.honorarios') ?>:</label>
                    <?php if($solicitud[0]->honorarios!=$solicitud[0]->honorarios_otro_si and $solicitud[0]->honorarios_otro_si){ ?>
                      <input type="text"   class="required old_field ho honorarios_otro_si honorarios" name="honorarios_otro_si" id="" value="<?=$solicitud[0]->honorarios_otro_si?>" style="background: #FAFACA;">
                    <?php }else{ ?>
                   ...
                   <div class="column two">
                    <label for=""><?php echo lang('global.honorarios_en_letras') ?>:</label>
                    <?php if($solicitud[0]->honorarios_letras!=$solicitud[0]->honorarios_letras_otro_si and $solicitud[0]->honorarios_letras_otro_si){ ?>
                      <input type="text"   class="required old_field hlo"  id="honorarios_letras_otro_si" name="honorarios_letras_otro_si" value="<?=$solicitud[0]->honorarios_letras_otro_si?>" style="background: #FAFACA;">
                    <?php }else{ ?>
                  ...
                  <?php if($solicitud[0]->honorarios!=$solicitud[0]->honorarios_otro_si and $solicitud[0]->honorarios_otro_si){ ?> 
                    <div class="column two" id="start_month_section"  >
                    <label><?php echo lang('global.inicio_otro_si_desde') ?>:</label>
                      <input type="text" id="start_month" name="mes_inicio" class="" value="<?=date("M-Y", strtotime($solicitud[0]->mes_otro_si))?>">
                  <?php }else{ ?>
                     <div class="column two" id="start_month_section"  style="display:none" >
                    <label><?php echo lang('global.inicio_otro_si_desde') ?>:</label>
                      <input type="text" id="start_month" name="mes_inicio" class="" value="">
                  <?php } ?>
                </div>
               ...
               <div class="clr6"></div>
                <div class="row">
                 ...
                 <div class="column three" style="width:35%;">
                    ...
                    <input type="checkbox" id="special_contidions"
                    <?php if ($solicitud[0]->condiciones_especiales): ?>
                      checked
                    <?php endif; ?> name="valida_condiciones"><?php echo lang('global.tiene_condiciones_especiales') ?></label>
                    <span>&nbsp;</span>
                  </div>
                <div class="clr6"></div>
                  <div class="column twelve" id="conditions_field"  <?php if (!$solicitud[0]->condiciones_especiales): ?> style="display:none;padding:0;" <?php endif ?>>
                    <div class="column twelve" id="conditions_field">
                      <label for=""><?php echo lang('global.condiciones_especiales') ?>:</label>
                      <textarea style="min-height:80px;" class="required" name="condiciones_especiales"><?php echo $solicitud[0]->condiciones_especiales ?></textarea>
                    </div>
                  </div>
                </div>
            ...
            <div class="info data-solicitud with_title">
              <div class="row">
                <div class="column twelve">
                  ...
                  <textarea cols="30" rows="10" name="razon_otro_si" id="razon_otro_si" class="required"><?php echo $solicitud['0']->razon_otro_si  ?></textarea>
                </div>
              </div>
            </div>
         <div class="clr6"></div>
