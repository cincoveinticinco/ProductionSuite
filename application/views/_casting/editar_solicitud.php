          ...
          <div class="column four">
           ...
           <div class="column four">
            ...
            <div id="initial_personaje" style="display:none;">
              ...
              <a href="#" class="eliminar_personaje" ><img src="<?php echo base_url($idioma.'images/delete_esc.png')?>" alt="" style="margin-top: 15px;"></a>
            </div>
            ...
            <div class="column two">
              <a href="#" id="add_personaje" style="margin-top: 16px;"><img src="<?php echo base_url($idioma.'images/plus.png')?>"></a>
            </div>
            <div class="clr6"></div>
