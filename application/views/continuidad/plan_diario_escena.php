...
<nav>
	<a href="<?php echo base_url($idioma.'continuidad/plan_diario/'.$produccion[0]->id_produccion.'/'.$id_unidad.'/'.$fecha_unidad) ?>"><?php echo lang('global.volver') ?></a>
...
<div class="resumen">
	...
	<div class="small-12 columns w-contentBox">
		...
		?>
		<div class="small-2 medium-1 columns box">
			<label>#</label>
			<?php echo $escena['0']->orden; ?>
		</div>
		<div class="small-3 medium-1 columns box">
			<label><?php echo lang('global.cap') ?></label>
			<?php echo $escena['0']->numero_capitulo; ?>
		</div>
		<div class="small-3 medium-1 columns box">
			<label><?php echo lang('global.esc') ?></label>
			<?php echo $escena['0']->numero_escena; ?>
		</div>
		<div class="small-2 medium-1 columns box">
			<label>CONT</label>
			<?php echo $escena['0']->dia_cont; ?>
		</div>
		<div class="small-2 medium-1 columns box">
			<label><?php echo lang('global.pag_ab') ?></label>
			<?php echo $escena['0']->libreto; ?>
		</div>
		<div class="small-4 medium-1 columns box">
			<label>D/N</label>
			<?php echo strtoupper($escena['0']->dian_noche); ?>
		</div>
		<div class="small-4 medium-1 columns box">
			<label>Int/Ext</label>
			<?php echo strtoupper($escena['0']->int_ext); ?>
		</div>
		<div class="small-4 medium-1 columns box">
			<label>Loc/Std</label>
			<?php echo mb_strtoupper($escena['0']->tipo); ?>
		</div>
		<div class="small-12 medium-4 columns box">
			<label><?php echo lang('global.locacion') ?> / <?php echo lang('global.set') ?>:</label>
			 <?php echo $escena['0']->locacion; ?> / <?php echo $escena['0']->sets; ?>
		</div>
		<div class="small-12 medium-6 columns box">
			<label><?php echo lang('global.descripcion') ?> / <?php echo lang('global.set') ?>:</label>
		...
		<div class="small-12 medium-6 columns box">
			<label><?php echo lang('global.guion') ?> / <?php echo lang('global.set') ?>:</label>
		...
		<div class="small-6 columns box">
			<label><?php echo lang('global.tiempo_estimado') ?>:</label>
			<span class="itemOrange">
				<?php echo $escena[0]->duracion_estimada_minutos.':'.$escena[0]->duracion_estimada_segundos;  ?>
			</span>
		</div>
		<div class="small-6 columns box">
			<label><?php echo lang('global.tiempo_real') ?>:</label>
...
<div class="contenido_sup" style="padding:0;">
	<div class="col" style="width:99%; padding:0px;">
		...
		<div class="small-12 columns table_tiempo" id="t_tiempos">
			...
			<div class="small-12 medium-3 columns">
					...
					<input type="text" class="hora" id="tomar_hora_ensayo-2" value="<?php if($escena['0']->comienzo_ens){ echo date("h:i:s A",strtotime($escena['0']->comienzo_ens)); } ?>">
					 <?php if($plan_actual[0]->estado_plan!="Cerrado" and $produccion['0']->estado!=2){ ?>
						 <?php if($escena['0']->comienzo_ens){ ?>
						   <a class="button expanded tomar_hora_manual"  data-tipo='1'><?php echo lang('global.modificar') ?></a>
						   <input type="hidden" value="<?php echo $id_escena ?>" class="id_escena">
							
							<!-- <a href="#asignarEscenasWrap" id="asignarEscenasLink" class="fancybox button expanded"><?php echo lang('global.multiescenas') ?></a> -->
						 <?php }else{ ?>
                           <a  class="button expanded btn_tomar_ahora" id="tomar_hora_ensayo" data-tipo='1'><?php echo lang('global.tomar_ahora') ?></a>
						 <?php } ?>
						<?php } ?>
					</div>
				</div>
				...
				<strong></strong>
					...
					<a class="button expanded btn_tomar_ahora_manual" id="tomar_hora_ensayo" data-tipo='1'><?php echo lang('global.guardar') ?></a>
				</div>	
				<div class="clr"></div>
			</div>
			<div class="small-12 medium-3 columns">
				...
				<div class="tomar hora_servidor-2">
					...
					<?php if($plan_actual[0]->estado_plan!="Cerrado" and $produccion['0']->estado!=2){ ?>
						<?php if($escena['0']->comienzo_prod){ ?>
							<a  class="button expanded tomar_hora_manual"  data-tipo='2'><?php echo lang('global.modificar') ?></a>
						<?php }else{ ?>
							<a  class="button expanded btn_tomar_ahora" id="tomar_hora_produccion" data-tipo='2'><?php echo lang('global.tomar_ahora') ?></a>
						<?php } ?>
					<?php } ?>
					</div>
				</div>
				<div class="tomar hora_manual-2" style="display:none">
					...
					<a class="button expanded btn_tomar_ahora_manual" id="tomar_hora_produccion" data-tipo='2'><?php echo lang('global.guardar') ?></a>
				</div>	
			</div>
			<div class="small-12 medium-3 columns">
				<?php
				...
				<div class="tomar hora_servidor-3">
					...
					<?php if($plan_actual[0]->estado_plan!="Cerrado" and $produccion['0']->estado!=2){ ?>
						<?php if($escena['0']->fin_produccion){ ?>
							<a  class=" button expanded tomar_hora_manual"  data-tipo='3'><?php echo lang('global.modificar') ?></a>
						<?php }else{ ?>
							<a  class="button expanded btn_tomar_ahora" id="tomar_fin_produccion" data-tipo='3'><?php echo lang('global.tomar_ahora') ?></a>
						<?php } ?>
					<?php } ?>									
					</div>
				</div>
				...
				<table cellspacing="0" cellpadding="0" class="horas_datos">
						...
						<a class="button expanded btn_tomar_ahora_manual" id="tomar_fin_produccion" data-tipo='3'><?php echo lang('global.guardar') ?></a>
				</div>		
			</div>
			<div class="small-12 medium-3 columns">
						...
						<div class="tr_real">
						    ...
						    <?php 
											    if($produccion['0']->estado!=2 and $plan_actual[0]->estado_plan!="Cerrado" AND $permisos_usuario!="read" AND ($escena[0]->estado_escena=='1' OR $escena[0]->estado_escena=='2' OR $escena[0]->estado_escena=='12' OR $escena[0]->estado_escena=='14')){ 
		                                            ...
		                                            if($temp_time){
		                                                echo anchor($idioma.'continuidad/desproducir_escena/'.$escena[0]->id_escena.'/'.date("Y-m-d",strtotime($plan_actual[0]->fecha_inicio)).'/'.$unidad[0]['id'].'/'.$produccion['0']->id_produccion.'/'.$temp_time[0]->id,'<div id="btn_desprod" class="button expanded alert">DESPRODUCIR</div>','onclick="return confirm('.lang('global.esta_seguro_que_desea_desproducir').')"');
		                                            }else{
		                                                echo anchor($idioma.'continuidad/desproducir_escena/'.$escena[0]->id_escena.'/'.date("Y-m-d",strtotime($plan_actual[0]->fecha_inicio)).'/'.$unidad[0]['id'].'/'.$produccion['0']->id_produccion,'<div id="btn_desprod" class="button expanded alert">DESPRODUCIR</div>','onclick="return confirm('.lang('global.esta_seguro_que_desea_desproducir').')"');
		                                            }
	                                        	}
                                            ?>	 		
						</div>
						<div class="small-12" id="btn_ins">	  	
						 ...
						 <a class="button expanded" id="save_tiempo_real"><?php echo lang('global.guardar') ?></a>
						 <?php } ?>	
