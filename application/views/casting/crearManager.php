                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="button" href="<?php echo base_url($idioma.'casting/eliminarManager/'.$l['id']) ?>" onclick="return confirm('Esta seguro de elimiar este Manager?')" ><?php echo lang('global.eliminar') ?></a> 
                        </td>
                    </tr>
                    <?php } ?>
                    </tbody>
