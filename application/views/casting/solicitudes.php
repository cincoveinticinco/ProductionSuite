  ...
  <div class="row">
        <div class="column twelve">
            <div class="colorsBox">
                <div class="row">
                   <ul>
                     <li><label class="label-fill"><span class="estado_color" style="background:#ccc;"></span><span><?php echo lang('global.generando_solicitud') ?> </span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#d9f3c2;"></span><span><?php echo lang('global.aprobacion_extranjero') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#BAF188;"></span><span><?php echo lang('global.solicitud_completa') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#85c646;"></span><span><?php echo lang('global.aprobada_produccion') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#B2E6FD;"></span><span><?php echo lang('global.generando_contrato') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#B6BFF1;"></span><span><?php echo lang('global.proceso_de_firma') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#B6BFF1;"></span><span><?php echo lang('global.proceso_de_firma_recoleccion') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#fdff91;"></span><span><?php echo lang('global.recolectar_documentos') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#fee93e;"></span><span><?php echo lang('global.terminada') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:black;color:white;"></span><span><?php echo lang('global.canceladas') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#6072D6;color:white;"></span><span><?php echo lang('global.anulado') ?></span></label></li>
                     <li><label class="label-fill"><span class="estado_color" style="background:#ff9400;"></span><span><?php echo lang('global.rechazado') ?></span></label></li>
                    </ul>
                </div>
            </div>
        </div>
      ...
      <thead>
        <tr>
          ...
          while ( $m < count($campos_usuario)-1) { 
            ...
            <?php }  else if($campos_usuario[$m]=="Estatus"){ $m++;?>
              <th><?php echo lang('global.estatus') ?></th>
            <?php } else if($campos_usuario[$m]=="Responsable"){ $m++;?>
              <th><?php echo lang('global.responsable') ?></th>
            <?php } else if($campos_usuario[$m]=="Producción"){ $m++;?>
              <th><?php echo lang('global.produccion') ?></th>
            <?php } else if($campos_usuario[$m]=="Personaje"){ $m++;?>
              <th><?php echo lang('global.personajes') ?></th>
            <?php } else if($campos_usuario[$m]=="Actor"){ $m++;?>
              <th><?php echo lang('global.actor') ?></th>
            <?php } else if($campos_usuario[$m]=="Monto"){ $m++;?>
              <th><?php echo lang('global.monto') ?></th>
            <?php } else if($campos_usuario[$m]=="Forma pago"){ $m++;?>
              <th><?php echo lang('global.tipo_de_pago') ?></th>
            <?php } else if($campos_usuario[$m]=="Fecha inicio"){ $m++;?>
              <th><?php echo lang('global.fecha_inicio') ?></th>
            <?php } else if($campos_usuario[$m]=="Fecha terminación"){ $m++;?>
                    ...
                    <?php if (Casting::permisos_solicitud($solicitud)=="write"): ?>
                                <tr class="estado_solicitud<?=$solicitud->id_estado?> row_solicitud">
                                  ...
                                  <?php $m=0; while ( $m < count($campos_usuario)-1) { ?>
                                    ...
                                    <?php }
                                     /// ESTADO SOLICITUD 
                                     else if($campos_usuario[$m]=="Estatus"){ ++$m;?>
                                    ...
                                    <?php } 
                                    /// RESPONSABLE -->
                                    else if($campos_usuario[$m]=="Responsable"){ ++$m;?>
                                      <td>
                                        <?php
                                    ...
                                    ////PRODUCCION -->
                                     else if($campos_usuario[$m]=="Producción"){ ++$m;?>
                                      <td><?=$solicitud->nombre_produccion?></td>
                                    <?php }
                                    ///PERSONAJE -->
                                    else if($campos_usuario[$m]=="Personaje"){ ++$m;?>
                                      <td class="nombre_elemento"><?=$solicitud->elementos?></td>
                                    <?php } 
                                    ////ACTOR 
                                    else if($campos_usuario[$m]=="Actor"){ ++$m;?>
                                      <td class="nombre_actor"><?=$solicitud->actor?></td>
                                    <?php }

                                    ///MONTO -->
                                    else if($campos_usuario[$m]=="Monto"){ ++$m;?>
                                    ...
                                    <?php } 
                                    //////FORMA DE PAGO -->
                                    else if($campos_usuario[$m]=="Forma pago"){ ++$m;?>
                                      <td>
                                        <?php
                                    ...
                                    ////FECHA INICIO -->
                                    else if($campos_usuario[$m]=="Fecha inicio"){ ++$m;?>
                                      <td><?=strftime("%d-%b-%Y",strtotime($solicitud->fecha_inicio))?></td>
                                    <?php }

                                    /// FECHA FINAL -->
                                     else if($campos_usuario[$m]=="Fecha terminación"){ ++$m;?>
                                      <td><?=strftime("%d-%b-%Y",strtotime($solicitud->fecha_final))?></td>
                                    <?php } ?>
